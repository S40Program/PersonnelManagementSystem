...
$(function(){
	$("#deptForm").submit(function(){
		...
		else if (!/^[0-9]*$/.test($.trim(basePay.val()))){
			msg = "基本工资只能填写数字！";
			workingdays.focus(); 
		}
		 else if (!/^[0-9]*$/.test($.trim(stationSalary.val()))){
				msg = "岗位工资只能填写数字！";
				workingdays.focus(); 
			}
    ...
    <div class="x-body">
        ...
        <input type="hidden" name="id" id="id" value="${job.id }" >
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <input type="text" id="stationSalary" name="stationSalary" required="" lay-verify="required"
                  autocomplete="off" class="layui-input" value="${job.stationSalary}">
              </div>
