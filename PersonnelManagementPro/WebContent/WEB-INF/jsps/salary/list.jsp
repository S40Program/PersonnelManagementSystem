...
<html>
  ...
  <body>
    <div class="x-nav">
      ...
      <button id="bbb" type="button" onclick="location.href='${ctx}/salary/add'" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:innert;margin-left:75%;;"  ><i class="layui-icon"></i>增加</button>
    ...
    <div class="x-body">
     ...
     <tr>
            <td>
              <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='2'><i class="layui-icon">&#xe605;</i></div>
            		  ...
            		  <td>${salary.job.name }</td>
					  <td>${salary.dept.name }</td>
					  <td>${salary.basePay}</td>
					  <td>${salary.stationSalary }</td>
            ...
            <td class="td-manage">
             ...
             <a title="编辑"  href='${ctx}/salary/edit?id=${salary.id}'>
     ...
     <div style="margin-left: 400px;" id="count1">
         <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${ctx}/salary/list?pageIndex={0}"/>
     </div>
