...
<html>
  ...
  <body>
    <div class="x-nav">
      ...
      <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${ctx }/uservisit/list" title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
    </div>
    <div class="x-body">
      <div class="layui-row" style="" align="center">
        <form class="layui-form layui-col-md12 x-so" method="get" action="${ctx }/uservisit/list">
     ...
     <div style="margin-left: 400px;" id="count1">
         <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${ctx}/uservisit/list?pageIndex={0}"/>
     </div>
    ...
    <script type="text/javascript">
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
              //发异步删除数据
              //等以后再使用异步，这里先使用
              $.get("${ctx}/uservisit/delete?id="+id);
