...
$(function(){
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${ctx}/train/add">
        <!-- id为员工信息id（也就是全局id） -->
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <select id="completion" name="completion" class="valid">
                    ...
                    <option value="${line.id}" <c:if test="${job.completion == line.id }">selected</c:if>>${line.name}</option>
                    </c:forEach>
                  </select>
              </div>
