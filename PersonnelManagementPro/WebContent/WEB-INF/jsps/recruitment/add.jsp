...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${ctx}/recruitment/add">
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <select id="jobtype" name="jobtype" class="valid" >
                    ...
                    <option value="${line.id}" <c:if test="${recruitment.jobtype_id == line.id }">selected</c:if>>${line.name}</option>
                    </c:forEach>
                  </select>
              </div>
          </div>
