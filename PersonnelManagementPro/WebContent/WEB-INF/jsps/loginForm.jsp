...
<link href="${ctx}/js/font-awesome-4.7.0/css/font-awesome.css" rel="stylesheet">
...
<!-- 登录错误提示，获取id对象，显示5秒钟后被隐藏，用none值隐藏id元素-->
<script type="text/javascript">
//登录密码，验证码错误提示
setTimeout(function(){document.getElementById("password_message").style.display="none";},5000);
setTimeout(function(){document.getElementById("new_message").style.display="none";},5000);
</script>
...
<div style="width:1349px;height:50px;background-color:rgb(19,19,70);">
      <ul style="margin-left:60px;padding-top:10px">
        ...
        <li style="display: inline-block; margin-left: 80px;"><a  style="font-size:24px;color:white;" >用户登录</a></li>
	...
	<div id="main" style="width:1349px;height:628px;float:left;">
      ...
      <div class="container" style="background-color:white;width:1349px;height:628px;">
       ...
       <div class="testSlider"></div>
		 ...
		 <div id="register"  class="register" style="height:350px;margin-top:100px;margin-left:200px;opacity:0.9;">
            <div class="title">
                <span style="color:black;">系统登录</span>
            ...
            <form  method="post" action="login" name="check-form" id="toLoginForm"> 
                ...
                <div class="default" style="margin-top:40px;">
                    <input data-form="uname" type="search" placeholder="请输入登录名"  onchange="tocheckLoginname()"  id="loginname" name="loginname" value="${user.loginname}"/>
                    <img src="js/metronic/img/bg/user.png" style="width:12px;"/>
                </div>
                ...
                <div class="default">
                    <input id="password" name="password" value="${user.password}" data-form="upwd" type="password" placeholder="请输入账号密码 "/>
            ...
            <div id="password_message" style="color: red;margin-left:120px;">${message}</div>
