    ...
    <div class="x-body">
        ...
        <input type="hidden" name="id" id="id" value="${employee.id }" >
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <input type="text" id="card_ide" name="card_id" required="" lay-verify="required"   disabled="disabled"
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <input type="text" id="card_idw" name="card_id" required="" lay-verify="required"   disabled="disabled"
          ...
          <div class="layui-form-item">
           ...
           <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <input type="text" id="card_idq" name="card_id" required="" lay-verify="required"   disabled="disabled"
          ...
          <div class="layui-form-item" >
              ...
              <div class="layui-input-inline">
                  <input type="text" id="card_idd" name="card_id" required="" lay-verify="required"   disabled="disabled"
