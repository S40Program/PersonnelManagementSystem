  ...
  <head>
    ...
    $(function(){
    	$("#deptForm").submit(function(){
    		...
    		else if (!/^[\u4E00-\u9FA5]{4,15}$/.test($.trim(remark.val()))){
				msg = "详细信息格式不正确！！！";
				remark.focus(); 
		    } 
    		if (msg != ""){
        ...
        <input type="hidden" name="id" id="id" value="${dept.id }" >
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                ...
                placeholder="不少于3个汉字"  autocomplete="off" class="layui-input" value="${dept.name }">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                 ...
                 placeholder="不少于4个汉字"   autocomplete="off" class="layui-input" value="${dept.remark }">
              </div>
