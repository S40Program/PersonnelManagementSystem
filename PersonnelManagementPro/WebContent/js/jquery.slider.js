	...
	$.fn.slider = function (options) {
		...
		return this.each (function(){
			var defaultValue = {
				...
				originPosition: 		'center', 				// 底部小圆点显示的位置    'center'  'right'
				...
				source: [
							{
								src: 'js/metronic/img/bg/bg1.jpg',									// 幻灯片图片地址		
								hasHref: true,												// 是否有链接
								href: '#',			// 链接地址					
								hrefTarget: '_self'											// 链接打开方式  _self, _blank, _top等
 							},
							{
								src: 'js/metronic/img/bg/bg2.jpg',
								hasHref: false,
								hrefTarget: '_self',
							},
							{
								src: 'js/metronic/img/bg/bg3.jpg',
								hasHref: false,
								hrefTarget: '_self',
							},
							{
								src: 'js/metronic/img/bg/bg4.jpg',
								hasHref: true,
								href: '#',
								hrefTarget: '_self'
							}
