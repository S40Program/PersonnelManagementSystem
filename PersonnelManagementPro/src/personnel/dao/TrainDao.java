...
import static personnel.util.common.Constants.TRAINTABLE;
...
import personnel.dao.provider.TrainDynaSqlProvider;
...
public interface TrainDao {
	...
	//查询
	    ...
	    @Results({
			...
			one=@One(select="personnel.dao.CompletionDao.get_Info",
			fetchType=FetchType.EAGER))
		})
