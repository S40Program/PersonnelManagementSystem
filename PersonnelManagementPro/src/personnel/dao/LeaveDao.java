...
import static personnel.util.common.Constants.LEAVETABLE;
...
import personnel.dao.provider.LeaveDynaSqlProvider;
...
public interface LeaveDao {
	...
	//查询
			...
			@Results({
				...
				one=@One(select="personnel.dao.LeaveTypeDao.get_Info",
				fetchType=FetchType.EAGER)),
				@Result(column="leavestatus",property="leavestatus",
				one=@One(select="personnel.dao.LeaveStatusDao.get_Info",
				fetchType=FetchType.EAGER))
			})
