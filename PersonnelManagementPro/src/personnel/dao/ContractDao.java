...
import static personnel.util.common.Constants.CONTRACTTABLE;
...
import personnel.dao.provider.ContractDynaSqlProvider;
...
public interface ContractDao {
	...
	//查询
			...
			@Results({
				...
				one=@One(select="personnel.dao.TraincontractDao.get_Info",
				fetchType=FetchType.EAGER)),
				@Result(column="LABOR_CONTRACT",property="laborContract",
				one=@One(select="personnel.dao.LaborcontractDao.get_Info",
				fetchType=FetchType.EAGER)),
				@Result(column="CONFIDENTIALITY_CONTRACT",property="confidentialityContract",
				one=@One(select="personnel.dao.ConfidentialitycontractDao.get_Info",
				fetchType=FetchType.EAGER)),
